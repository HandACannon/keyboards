...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_3x10_7(
        ...
        KC_TAB,  KC_Q,         KC_W, KC_F,    KC_P,    KC_G,           KC_J, KC_L,          KC_U,          KC_Y,   KC_BSPC,         KC_TAB,
        KC_ENT,  KC_A,         KC_R, KC_S,    KC_T,    KC_D,           KC_H, KC_N,          KC_E,          KC_I,   KC_O,            KC_QUOT,
        KC_LGUI, LSFT_T(KC_Z), KC_X, KC_C,    KC_V,    KC_B,           KC_K, KC_M,          KC_COMMA,      KC_DOT, RSFT_T(KC_SLSH), KC_LGUI,
                 TD(TD_ESC_SPOTLIGHT_EMOJI),           LGUI_T(KC_SPC),                                     MO(1)         
    ), 
